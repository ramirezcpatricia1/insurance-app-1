    ...
    <>
      <Layout>
        <form onSubmit={onSubmit} className="ml-20 relative">
          <h1 className="h-10 text-center">Incident Mobile Equipment</h1>
          {/*<SelectEquipment />*/}
          <div className="flex flex-col">
            ...
            <label>
              {" "}
              Causes of the incident: Describe the circumstances that led to the
              incident. provide details any contributing factors such a weather
            ...
            ></textarea>
            {errors.whatHappened?.type === "required" && (
              <p> The field facts is required</p>
            )}
            <label>
              {" "}
              In this part detail what happened with the Equipment Mobile.
              Describe the physical damage, injures, or any type of event that
              occurred.
            </label>
            <textarea
              type="text"
            ...
            <label htmlFor="file ">
              Attach wide-angle photos showing the accident scene and the
              accident
            </label>
            <input
              type="file"
              className="text-black"
              {...register("wideangle", { required: true })}
            ></input>
            {errors.wideangle?.type === "required" && (
              <p> The field photos is required</p>
            )}

            <label htmlFor="file ">
              Please, attach photos or visual evidence of the incident and the
...
export default IncidentMobileEquipment;
